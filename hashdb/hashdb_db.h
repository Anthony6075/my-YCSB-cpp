#ifndef YCSB_C_HASHDB_DB_H_
#define YCSB_C_HASHDB_DB_H_
...
private:
    ...
    std::string BuildCompKey(const std::string &key,
    ...
    Status ScanSingleEntry(const std::string &table, const std::string &key,
    ...
    Status ReadCompKeyRM(const std::string &table, const std::string &key,
                         const std::vector<std::string> *fields,
                         std::vector<Field> &result);
    Status ScanCompKeyRM(const std::string &table, const std::string &key,
                         int len, const std::vector<std::string> *fields,
                         std::vector<std::vector<Field>> &result);
    Status ReadCompKeyCM(const std::string &table, const std::string &key,
                         const std::vector<std::string> *fields,
                         std::vector<Field> &result);
    Status ScanCompKeyCM(const std::string &table, const std::string &key,
                         int len, const std::vector<std::string> *fields,
                         std::vector<std::vector<Field>> &result);
    ...
    Status (HashdbDB::*method_read_)(const std::string &, const std::string &,
                                     const std::vector<std::string> *,
                                     std::vector<Field> &);
    Status (HashdbDB::*method_scan_)(const std::string &, const std::string &,
                                     int, const std::vector<std::string> *,
                                     std::vector<std::vector<Field>> &);
    Status (HashdbDB::*method_update_)(const std::string &, const std::string &,
                                       std::vector<Field> &);
    Status (HashdbDB::*method_insert_)(const std::string &, const std::string &,
                                       std::vector<Field> &);
    Status (HashdbDB::*method_delete_)(const std::string &,
                                       const std::string &);
